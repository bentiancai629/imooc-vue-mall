<template>
    <div>
                            ...
                            <li v-for="item in cartList">
                                <div class="cart-tab-1">
                                    <div class="cart-item-check">
                                        <!--<a href="" class="checkbox-btn item-check-btn" v-bind:class="{'check':item.checked=='1'}" @click="editCart('checked',item)">-->
                                ...
                                <div class="cart-tab-4">
                                    <div class="item-price-total">{{(item.productNum*item.salePrice)}}
                                    </div>
                                </div>
        ...
        <!--            &lt;!&ndash;b绑定一个属性 modalConfirm &ndash;&gt;-->
